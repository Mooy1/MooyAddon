...
public final class MobData {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard(PIG, MobDataTier.PASSIVE, new ItemStack[] {
                new ItemStack(Material.POTATO, 64), new ItemStack(Material.PORK, 64), new ItemStack(Material.CARROT, 64),
                new ItemStack(Material.GRILLED_PORK, 64), EMPTY_DATA_CARD, new ItemStack(Material.GRILLED_PORK, 64),
                new ItemStack(Material.CARROT, 64), new ItemStack(Material.PORK, 64), new ItemStack(Material.POTATO, 64)
